...
public class Restaurants {
    ...
    public static void loadData(String filePath) throws IOException {
        ...
        for (int i = 0; i < restaurants.length(); i++) {
            ...
            String name = fixString(restaurant.getString("name"));
            String kind = fixString(restaurant.getString("kind"));
            addRestaurant(restaurant.getInt("id_restaurant"), name, kind, restaurant.getInt("tables"), restaurant.getString("pricing"));
